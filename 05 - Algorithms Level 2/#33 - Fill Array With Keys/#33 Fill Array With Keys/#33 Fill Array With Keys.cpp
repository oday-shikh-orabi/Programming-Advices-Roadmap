...
void FillArrayWithKeys(string* KeysArray,int LengthArray)
{
    for (int i = 0; i < LengthArray; i++)
    {
        KeysArray[i] = GenerateKey();
        
    }
}
void PrintKeys(string* KeysArray,int LengthArray)
{
    cout << endl;
    cout << "Arry Elements : \n" << endl;
    for (int i = 0; i < LengthArray; i++)
...
int main()
{
    ...
    int LengthArray = ReadPositiveNumber("Pleaes enter how many keys to generate? ");

    FillArrayWithKeys(KeysArray,LengthArray);
    PrintKeys(KeysArray, LengthArray);
