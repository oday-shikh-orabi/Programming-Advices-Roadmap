...
stDate IncreaseDateByOneMonth(stDate Date)
{
    ...
    // åí ãÔÇä áãÇ íßæä ÇáÊÇÑíÎ 31\1\2022 æÊÒíÏ ÔåÑ ÊØáÚ ÒíÇÏÉ ÇáÔåÑ ÕÍíÍÉ 31\2\2022 åí ÛáØ
    // åíß áÇÒã Êßæä 28\2\2022 ØÈÚÇ Úä ØÑíÞ Çäæ ãäÔæÝ ÇÐÇ ÇßÈÑ ÚÏÏ ÇíÇã ÈÇáÔåÑ ÇáËÇäí ÇÕÝÑ ãä ÇßÈÑ ÚÏÏ ÇáÔåÑ íáí ÞÈáæ 31
    // ÝãäÇÎÏ ÇßÈÑ ÚÏÏ ÈÇáÔåÑ ÇáËÇäí æãäÃÓäÏæ ááÇíÇã Úä ØÑíÞ ÇáÝÇäßÔä ÊÈÚ ÇíÇã ÇáÔåÑ
