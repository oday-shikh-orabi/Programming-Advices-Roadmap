...
public:
    ...
    clsPerson(string AddressLine1, string AddressLine2, string City, string Country):Address(AddressLine1, AddressLine2, City, Country)
    {
...

{
    ...
    clsPerson Person1("Building 10", "Queen Rania Street", "Amman", "Jordan");
